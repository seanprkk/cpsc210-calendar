...
/*
Represents the main GUI where user can browse and select calendars in the workroom.
 */
public class CalendarsApp implements ActionListener {
    ...
    private JButton selectCalendarButton;
